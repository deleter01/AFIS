	...
	<div class="container-login100" style="background-image: url('https://mdbcdn.b-cdn.net/img/Photos/new-templates/search-box/img4.webp');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" method="post" action="index.php">
				...
				<div>
					<p class="text-center text-muted mt-5 mb-0"><a href="forget.php" class="fw-bold text-body">Forgot Password?</a><br>
					<a href="reg_user.php" class="fw-bold text-body">Create Account!</a>
				</p>
				</div>
			</form>
