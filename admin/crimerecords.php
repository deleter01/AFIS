...
<div class="dir">
        ...
        <a href="dashboard.php">Home</a> <i class="fa fa-chevron-right"></i><label>Crime Reports</lable>
...
<div class="line"></div>
    <div class="cards">
                            ...
                            $place_crime = mysqli_real_escape_string($mysqli,$_POST['pfcrime']);
                            $as = rand(1000,9999);     
        ...
        <div class="col-lg-6">
            <label>Type of Crime:</label>
             <select class="form-control" name="typefcrime">
              <option>Crime against Persons</option>
              <option>Crime against Property</option>
              <option>Crime against Morality</option>
              <option>White-collar crime</option>
              <option>Organized crime</option>
              <option>Corporate crime</option> 
              <option>Cyber crime</option>
              <option>Transactional crime</option>            
              </select>
            </div>
            <div class="col-lg-6">
            <label>Place of Crime:</label>
            <input type="text" class="form-control" name="pfcrime" pattern="[A-Za-z]{3,}" required>
            </div>   
        </div>
        <div class="row form-group">
          <div class="col-lg-12">
            <label>Sentence Served:</label>
